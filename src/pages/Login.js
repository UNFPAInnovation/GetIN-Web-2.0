...
export  default class Login extends Component {
  ...
  render() {
    return (
      ...
      <input type="text" id="username" className="form-control" onChange={this.handleChange} value={this.state.username} name="username"  placeholder="Username :" required autoFocus={true} />
      <br/>
      <label htmlFor="inputPassword" className="sr-only">Password</label>
      <input autoComplete="true" type="password" id="password" onChange={this.handleChange} value={this.state.password} name="password" className="form-control" placeholder="Password" required/>
      <br/>     
      <button className="btn btn-lg btn-primary full-width" type="submit">Sign in</button>
      <br/>
    </form>
            </div>
